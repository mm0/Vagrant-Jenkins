...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "ansible" do |ansible|
    ansible.extra_vars      = { target: ansible_host, ansible_ssh_user: "vagrant", server_hostname: hostname, web_directory: web_directory, server_domain: server_domain, extra_packages_to_install: [ "make" ]  }
